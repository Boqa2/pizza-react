...
const ItemsSearch = ({ id, title, priseForSearch, imageUrl}:ItemSearch) => {
  return (
    <Link to={`search/carditems/${id}`} className="w-full py-2 h-full z-10 px-3 items-center dark:bg-indigo-400  dark-border space-x-5 rounded-2xl border flex bg-white">
